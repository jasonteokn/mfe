  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      remotes: {
        ...
        auth:`auth@${domain}/auth/latest/remoteEntry.js`, // Fill in the hosted domain name
        dashboard:`dashboard@${domain}/dashboard/latest/remoteEntry.js`, // Fill in the hosted domain name
      },
